...
import xyz.synse.datacenter.algorithms.filters.BlurFilter;
import xyz.synse.datacenter.algorithms.filters.GrayFilter;
...
public class MotionDetection {
	 ...
	 */
	private final BlurFilter blur = new BlurFilter(4, 4, 1);

	/**
	 * Gray filter instance.
	 */
	private final GrayFilter gray = new GrayFilter();
	 ...
	 */
	public MotionDetection(int pixelThreshold, double areaThreshold) {
